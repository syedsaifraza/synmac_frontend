  ...
  return (
    <div>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-0">
        ...
        <div className="text-black py-8 sm:py-12 lg:py-16 space-y-3 ">
              <h1 className='text-3xl text-gray-900 font-semibold'>Product Applications</h1>
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed fonts" 
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4 mb-8 sm:mb-12 fonts">
            ...
            {productData?.msds_doc && (
              <a
                ...
                rel="noopener noreferrer"
                className={`inline-flex items-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 border rounded-lg font-medium transition-colors duration-200 text-sm fonts sm:text-base
    ...
    <Product_Section product_list={productData.relatedProduct} title={"Related Products"}/>
