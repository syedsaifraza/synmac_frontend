    ...
    <section className="relative h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto max-w-6xl">
        <div className="max-w-2xl animate-fade-in-up">
          ...
          <div   dangerouslySetInnerHTML={{ __html: data?.description || "" }} className="text-white/80 text-sm sm:text-base md:text-lg fonts ql-editor max-w-xl mb-6 sm:mb-8 md:mb-10 leading-relaxed ql-editor"
